            ...
            >
              <Popover.Panel className="absolute bg-white  top-full z-10 mt-3 w-[160px]  overflow-hidden hover:cursor-pointer  shadow-lg text-[#646464] ">
                <div className=" gap-y-3">
                  <div className="w-full pl-2 py-3 mt-1 hover:bg-[#ececec]"><a  href="">RDC</a></div>
                  <div className="w-full pl-2 py-3 mt-1 hover:bg-[#ececec]"><a href="">EQUITY GROUP</a></div>
                  <div className="w-full pl-2 py-3 mt-1 hover:bg-[#ececec]"><a href="">KENYA</a></div>
                  <div className="w-full pl-2 py-3 mt-1 hover:bg-[#ececec]"><a href="">OUGANDA</a></div>
                  <div className="w-full pl-2 py-3 mt-1 hover:bg-[#ececec]"><a href="">TANZANIA</a></div>
                  <div className="w-full pl-2 py-3 mt-1 hover:bg-[#ececec]"><a href="">RWANDA</a></div>
                  <div className="w-full pl-2 py-3 mt-1 hover:bg-[#ececec]"><a href="">SOUDAN DU SUD</a></div>
                </div>

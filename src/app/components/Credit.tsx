    ...
    <div className='pb-8'>
        <div className='w-full bg-[#a22a2b] '>
                <p className='text-center text-white py-10 font-semibold text-lg'>
                    EQUITY BCDC DIASPORA - SIMULATEURS DE REMBOURSEMENT</p>
            </div>
            ...
            <div className="w-full md:px-[60px] px-4 block md:flex gap-x-[50px]">
              ...
              <div className=' block md:flex gap-x-[30px] w-full md:w-auto'>
                    ...
                    <div className='flex gap-x-[1px] mt-2 md:mt-0'>
                        <p>$</p>
                        <input type="text" placeholder='' className='border-[2px] border-[#f0f0f0] outline-[#a22a2b] w-[90%] md:w-auto py-2 mt-[-9px] text-end rounded-[10px] pr-2 '/>
                        <p>pm</p>
                    </div>
                ...
                <div className=' block md:flex gap-x-[30px] w-full md:w-auto'>
                    ...
                    <div className='flex gap-x-[1px] mt-2 md:mt-0'>
                        ...
                        <input type="text" placeholder='' value="15.7" className='border-[2px] border-[#f0f0f0] outline-[#a22a2b] w-[90%] md:w-auto py-2 mt-[-9px] text-end rounded-[10px] pr-2 '/>
                        <p>%</p>
                    </div>
                ...
                <button className='bg-[#a22a2b] py-2 px-5 text-white w-full rounded-[15px] font-semibold'>CALCULEZ</button>
                </div>
              </div>
              <div className=' md:w-[430px] w-full'>
                <p className='text-center text-xl font-medium'>Paiement Mensuel</p>
               ...
               <div className='mt-9'>
                <button className='bg-[#a22a2b] py-2 px-5 text-white w-full rounded-[15px] font-semibold'>DEMANDER UNE PRE-EVALUATION</button>
               </div>
              </div>
             </div>
        ...
        <p className='text-black text-[14px]  px-4 lg:px-[70px] '>* Le taux d'intérêt est fixé par défaut au taux préférentiel. Les institutions bancaires peuvent choisir de prêter aux particuliers à un taux supérieur ou inférieur à ce taux préférentiel.</p>
           ...
           <div className='px-4 w-full ' >
            <img src={head2.src} className=' rounded-[15px] hidden md:flex md:w-full md:h-[250px] lg:flex lg:w-[1105px] h-[100px] lg:h-auto mt-10 lg:rounded-2xl'  alt=''  />

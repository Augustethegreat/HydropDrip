...
import { Bars3Icon, XMarkIcon, EnvelopeIcon, QuestionMarkCircleIcon, UserCircleIcon, CreditCardIcon, BanknotesIcon,   } from "@heroicons/react/24/outline";
import {ChatBubbleLeftIcon,ChevronDownIcon,ChevronUpIcon,ChatBubbleBottomCenterTextIcon,HomeIcon,PaperAirplaneIcon,PhoneIcon,PlayCircleIcon, RectangleGroupIcon, PhoneXMarkIcon, WalletIcon} from "@heroicons/react/20/solid";
import { Dialog, Disclosure, Popover, Transition } from "@headlessui/react";
import { SocialIcon } from 'react-social-icons'
import { cn } from "./lib/utils";
import logoPic from "../app/Sammy/img/hydrodrip logos.png"

import {motion} from "framer-motion"
import Body from "./Sammy/Body";
...
export default function Home2() {
  ...
  return (
    <main className={`min-h-screen filter   items-center justify-between bg-[#ffffff] `}>
            {/* <div className=" fixed w-[100%] h-[100%] overflow-hidden opacity-10 "></div> */}


  <header  className=" h-15 border-b-2  bg-white    ">

      <nav
        className="mx-auto flex max-w-7xl  items-center pt-1 md:pt-1  justify-start p-0 lg:px-8"
        aria-label="Global"
      >
        ...
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.1 pb-2">
            
            {/* <h3 className="h-9 w-auto pr-25 md:pr-80 lg:pr-0 font-bold text-white text-lg mt-2  md:top-0"> EQUITY-BCDC</h3> */}
          ...
          <a href="/" className={`font-medium text-[15px] leading-6 text-[#000] border-b-[4px] border-b-[#fff] hover:text-[#50b7e5] hover:border-b-[#50b7e5] ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`}>
          <p className="px-3">Home</p>
          </a>          
          <a href="#credits" onClick={visualroute} className={`font-medium text-[15px] leading-6 pb-0 md:pb-2 text-[#000] border-b-[4px] border-b-[#fff] hover:text-[#50b7e5] hover:border-b-[#50b7e5] ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`}>
                <p className="px-3">
                Our Solution
                </p>
          </a>
          ...
          <Popover className="relative">
            <Popover.Button onClick={change} className={`font-medium text-[15px] flex outline-none leading-6 pb-0 md:pb-2 text-[#000] border-b-[4px] border-b-[#fff]  ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`}>
                <p className="px-3">
                Simulateurs
                </p>
              <ChevronDownIcon
            ...
            >
              <Popover.Panel className="absolute bg-white  top-full z-10 mt-3 w-[160px]  overflow-hidden hover:cursor-pointer  shadow-lg text-[#646464] ">
                <div className=" gap-y-3">
                      <div onClick={creditroute} className="w-full pl-2 py-3 mt-1 text-white hover:text-white hover:bg-[#a22a2b] bg-white">
                      <a href="#credits"  >
                        Crédits
                      </a>
                      </div>
                  <div onClick={depotroute} className="w-full pl-2 py-3 mt-1 text-white hover:text-white hover:bg-[#a22a2b] bg-white">
                  <a href="#depot" >
                        DAT
                      </a>
                  </div>
            ...
            <a href="#offres" onClick={packroute} className={`font-medium text-[15px] leading-6 text-[#000] border-b-[4px] border-b-[#fff] hover:text-[#50b7e5] hover:border-b-[#50b7e5] ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`}>
             <p className="px-3">Services</p>
          </a>
          <a href="#offres" onClick={packroute} className={`font-medium text-[15px] leading-6 text-[#000] border-b-[4px] border-b-[#fff] hover:text-[#50b7e5] hover:border-b-[#50b7e5] ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`}>
             <p className="px-3">Get in Touch</p>
          </a>
          <a href="#about" onClick={aboutroute} className={`font-medium text-[15px] leading-6 text-[#000] border-b-[4px] border-b-[#fff] hover:text-[#50b7e5] hover:border-b-[#50b7e5] ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`}>
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto shadow-[2px_3px_5px_black] bg-[#ffffff] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <Popover className="relative">
            <Popover.Button onClick={change} className="flex gap-x-6 hover:text-[#45aad7]">
            ...
            >
              <Popover.Panel className="absolute ml-10 bg-white  top-full z-10 mt-3 w-[160px]  overflow-hidden hover:cursor-pointer  shadow-lg text-[#646464] ">
                ...
                <a
                  href="#depot"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-white hover:bg-[#f2f2f2] hover:text-[#45aad7]"
                ><div className="flex gap-x-6 hover:text-[#45aad7]" onClick={depotroute}>
                   <BanknotesIcon className="h-7 w-7 text-[#616f8d] mt-0 hover:text-white" aria-hidden="true"/>
                ...
                <a
                 href="#offres"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-white hover:bg-[#f2f2f2] hover:text-[#45aad7]"
                ><div className="flex gap-x-6 hover:text-[#45aad7]"  onClick={packroute}>
                ...
                onClick={aboutroute}
                 href="#about"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-white hover:bg-[#f2f2f2] hover:text-[#45aad7]"
                ><div onClick={aboutroute} className="flex gap-x-6 hover:text-[#45aad7]"  >
        ...
        <Dialog.Panel className="relative max-w-4xl lg:w-[1900px] p-6 bg-[#fcfcfc] rounded shadow-lg">
          ...
          <div className="block md:flex lg:flex mt-4  gap-x-1 lg:w-[300px]">
            <div className="mt-4 shadow-lg pl-2 border-gray-300 md:pt-8 lg:pt-8 pr-12 pb-5 border-t-[2px] border-t-[#f6f6f6]">
              ...
              <p className="text-white hover:text-[#a22a2b]  text-[16px] font-bold">Forgot your password?</p>
              </div>
            </div>
            ...
            <div className="mt-4 shadow-lg lg:w-[800px] border-gray-300 md:pl-[90px] md:pr-0 lg:pl-[90px] lg:pr-[50px] pb-5 pt-8 border-t-[2px] border-t-[#f6f6f6]">
              <p className="text-white text-2xl">New User ?</p>
              ...
              <p className="text-white hover:text-[#a22a2b]  text-[11px] font-bold">Site Guide</p>

          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-2 hover:cursor-pointer" onClick={() => setLoginOpen(true)}>
                <p className="text-white font-medium text-[15px]">Bonjour !</p>
                <a
                  href="#"
                ...
                <a
                  href="/"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-white hover:bg-[#f2f2f2] hover:text-white"

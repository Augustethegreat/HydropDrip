...
function Slides() {
  return (
    <div className='  '>
        ...
        <div className='max-w-screen-0 w-full md:w-auto md:max-w-screen-lg flex mt-[-160px] px-0 md:px-[110px] space-x-[70%] md:space-x-[80%] lg:space-x-[77%]'>
       <button
          className="absolute mt-[-100px] md:mt-[-130px]  bg-black bg-opacity-80 md:bg-opacity-50 px-0 py-2 rounded-full"
